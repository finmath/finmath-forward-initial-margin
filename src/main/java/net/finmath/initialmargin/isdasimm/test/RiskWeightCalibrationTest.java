...
public class RiskWeightCalibrationTest {
	...
	public static SIMMSimpleSwap[] createCalibrationProducts(double notional, int[] numberOfPeriods, double periodLength, ForwardCurveInterpolation forwardCurve, DiscountCurveInterpolation discountCurve) throws CalculationException {
