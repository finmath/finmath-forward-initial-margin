...
/**
 * Implements the valuation of a cancelable swap under a <code>LIBORModelMonteCarloSimulationModel</code>
 *
...
public class BermudanSwaption extends AbstractLIBORMonteCarloRegressionProduct {
	...
	public RandomVariable getValue(double evaluationTime, LIBORModelMonteCarloSimulationModel model) throws CalculationException {
		...
		RandomVariable valuesUnderlying = new RandomVariableFromDoubleArray(fixingDates[fixingDates.length - 1], 0.0);
	...
	private RandomVariable[] getRegressionBasisFunctions(double fixingDate, LIBORModelMonteCarloSimulationModel model) throws CalculationException {
		...
		// Constant
		RandomVariable basisFunction = new RandomVariableFromDoubleArray(fixingDate, 1.0);
