...
public class SimmBpvTimelineTest {
	...
	public void testGetSimmSensitivitiesAtTimeZeroForExactMaturities(@FromDataPoints("vertices") Vertex maturityAccordingToSimm,
		...
		assertThat(new SimmBpvTimeline(spec).getSimmSensitivities(0.0, getDummyModel()),
				hasEntry(equalTo(new Simm2Coordinate(maturityAccordingToSimm, irCurve.getName(), irCurve.getCurrency(), RiskClass.INTEREST_RATE, MarginType.DELTA, ProductClass.RATES_FX)),
